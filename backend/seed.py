...
items = [
    ...
    {"resource": "profile", "code": "utama", "title": "Aktivitas siswa di lingkungan sekolah", "description": "Foto besar di section Tentang Kami.", "image_url": "https://images.unsplash.com/photo-1719159381981-1327b22aff9b?auto=format&fit=crop&w=900&q=85", "is_published": True},
    {"resource": "profile", "code": "sekunder", "title": "Siswa berkegiatan di ruang praktik", "description": "Foto kecil yang tumpang tindih di section Tentang Kami.", "image_url": "https://images.unsplash.com/photo-1630331515839-dcf1de4e8d4d?auto=format&fit=crop&w=900&q=85", "is_published": True},
