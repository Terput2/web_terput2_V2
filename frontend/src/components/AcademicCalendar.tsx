  ...
  return (
    <div className="grid gap-5 xl:grid-cols-[1.18fr_.82fr]" data-testid="academic-calendar">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4" data-testid="latest-news-card"><div className="flex items-center gap-2 text-[#0f4c81]"><Newspaper size={16} /><span className="text-[10px] font-extrabold uppercase tracking-wider">Berita terbaru</span></div><p className="mt-2 text-sm font-bold text-slate-700" data-testid="latest-news-title">{news[0]?.title ?? "SPMB Tahun Ajaran 2027/2028 Dibuka"}</p></div>
      </div>
    </div>
  );
}