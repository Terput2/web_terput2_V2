...
export default function Home() {
  ...
  const heroImages = (heroContent.data ?? []).map((item) => item.image_url).filter((url): url is string => Boolean(url));
