...
const whatsappUrl = "https://wa.me/6281398865871?text=Halo%20SMK%20Teratai%20Putih%202%2C%20saya%20ingin%20mendapatkan%20informasi%20PPDB.";
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#f8fafc] pb-16 text-slate-900 sm:pb-0" data-testid="school-website-shell">
      ...
      <div className="bg-[#092c4c] px-5 py-2.5 text-center text-xs font-semibold tracking-wide text-white sm:text-sm" data-testid="announcement-bar">
        <span className="mr-2 text-amber-300">●</span> PPDB TA 2026/2027 telah dibuka — kesempatan beasiswa prestasi menanti Anda
      ...
      <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-white/90 shadow-sm backdrop-blur-xl" data-testid="site-header">
        <div className="mx-auto flex h-[76px] max-w-7xl items-center justify-between px-5 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button onClick={() => setIsPpdbOpen(true)} className="hidden rounded-full bg-amber-500 px-5 font-bold text-[#092c4c] shadow-lg shadow-amber-500/20 transition-all hover:-translate-y-0.5 hover:bg-amber-400 sm:inline-flex" data-testid="header-ppdb-button">PPDB Online <ArrowUpRight size={16} /></Button>
          ...
          <div className="mx-auto grid min-h-[690px] max-w-7xl items-center gap-12 px-5 py-16 lg:grid-cols-[1.02fr_.98fr] lg:px-8 lg:py-20">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .65 }} className="relative z-10" data-testid="hero-copy">
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                <Button onClick={() => setIsPpdbOpen(true)} className="h-12 rounded-full bg-amber-500 px-6 text-sm font-extrabold text-[#092c4c] shadow-xl shadow-amber-500/20 transition-all hover:-translate-y-1 hover:bg-amber-400" data-testid="hero-ppdb-button">Jelajahi PPDB 2026 <ArrowUpRight size={17} /></Button>
